...
Fork of the [Mediamtx](https://github.com/bluenviron/mediamtx) media server including the following changes:

- Add authJWTTrustStorePem config property
- Add logFileLimitMB config property
